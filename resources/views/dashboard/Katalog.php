...
<div class="max-w-screen-xl mx-auto p-4">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Мотоциклы</h1>
    <div class="bg-white p-4 rounded shadow">
        <div class="flex space-x-4 mb-4">
            <button class="px-4 py-2 bg-gray-900 text-white rounded hover:bg-gray-800">Все</button>
            <button class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">Новые</button>
            <button class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">С пробегом</button>
            <button class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">В наличии</button>
            <button class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">Под заказ</button>
        </div>
        <div class="grid grid-cols-6 gap-4 mb-4">
            ...
            <button class="col-span-1 bg-gray-900 text-white px-4 py-2 rounded hover:bg-gray-800">Поиск</button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-3 gap-6 mt-6">
        <div class="bg-white p-4 rounded shadow">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRh1eHA6oqIndVaJ5p7sHhokwcFg6keUi9kfw&s"
                 alt="Car" class="rounded mb-4">
            <h2 class="text-lg font-bold">Hyundai Solaris 2 Рестайлинг, 2022</h2>
            <p class="text-gray-500">19 000 $</p>
            <p class="text-sm text-gray-500">35 000 км • Робот • Передний привод</p>
            <p class="text-sm text-gray-500">1.4/100 л.с./Бензин • США</p>
        </div>
        <div class="bg-white p-4 rounded shadow">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRh1eHA6oqIndVaJ5p7sHhokwcFg6keUi9kfw&s"
                 alt="Car" class="rounded mb-4">
        ...
        <div class="bg-white p-4 rounded shadow">
            ...
            <p class="text-sm text-gray-500">35 000 км • Робот • Полный привод</p>
            <p class="text-sm text-gray-500">1.4/100 л.с./Бензин • Европа</p>
        </div>
    </div>
</div>
